...
- The chat command exposed to the user will be called /scraperapi, and should be placed in
  pkg/scraperapi/chatCommands/scraperapi.js
...
- Provide methods:
- async fetchHtml(url: string, opts?: { render?: boolean; countryCode?: string; headers?: Record<string,string> }):
  Promise<string>
- async googleSerp(query: string, opts?: { countryCode?: string; tld?: string; outputFormat?: 'json'|'csv';
  googleParams?: Record<string,string|number> }): Promise<any>
- async googleNews(query: string, opts?: { countryCode?: string; tld?: string; outputFormat?: 'json'|'csv';
  googleParams?: Record<string,string|number> }): Promise<any>
